        ...
        <div className="container-custom">
          <div className="bg-white rounded-xl p-6 shadow-md">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                <h3 className="font-bold text-primary mb-2">Size Matters</h3>
