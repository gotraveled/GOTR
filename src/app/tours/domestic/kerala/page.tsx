...
export const metadata: Metadata = {
  title: 'Kerala Tour Package - God\'s Own Country | GoTraveled',
  description: 'Explore Kerala - discover beautiful attractions and create unforgettable memories.',
};
  ...
  return (
    <div>
      <section className="relative h-[600px]">
        <Image src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&q=80" alt="Kerala" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-black/70"></div>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <nav className="text-sm mb-4"><Link href="/tours" className="hover:underline">Tours</Link> / <Link href="/tours/domestic" className="hover:underline ml-1">Domestic</Link> / <span className="ml-1">Kerala</span></nav>
            <h1 className="text-5xl md:text-7xl font-bold mb-4">Kerala Tour Package - God\'s Own Country</h1>
            <p className="text-2xl md:text-3xl mb-6">🌴 God\'s Own Country 🌴</p>
            <p className="text-xl max-w-3xl mx-auto">Discover the beauty and charm of Kerala with unforgettable experiences</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center p-6 bg-blue-50 rounded-xl"><div className="text-4xl mb-3">🌡️</div><h3 className="font-bold text-lg mb-2">Best Time</h3><p className="text-gray-700">Sept-March</p></div>
          ...
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold mb-6">About Kerala</h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">Kerala is a beautiful destination in Kerala offering stunning natural beauty, rich cultural heritage, and memorable experiences for travelers.</p>
            <p className="text-gray-700 text-lg leading-relaxed">From scenic attractions to adventure activities, Kerala provides the perfect blend of relaxation and excitement for all types of travelers.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md"><h3 className="text-xl font-bold mb-4 text-blue-600">Best Season</h3><p className="text-gray-700 mb-2"><strong>Peak Season:</strong> Sept-March</p><p className="text-gray-700">Plan your visit during these months for the best experience.</p></div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-4xl">
          <TourInquiryForm tourName="Kerala Tour Package - God\'s Own Country" destination="Kerala, South India" />
        </div>
      </section>
