...
export const metadata: Metadata = {
  title: 'Mount Abu Tour Package - Hill Station of Rajasthan | GoTraveled',
  description: 'Explore Mount Abu - discover beautiful attractions and create unforgettable memories.',
};

export default function MountAbuTourPage() {
  const attractions = [
  ...
  return (
    <div>
      <section className="relative h-[600px]">
        <Image src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&q=80" alt="Mount Abu" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-black/70"></div>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <nav className="text-sm mb-4"><Link href="/tours" className="hover:underline">Tours</Link> / <Link href="/tours/domestic" className="hover:underline ml-1">Domestic</Link> / <span className="ml-1">Mount Abu</span></nav>
            <h1 className="text-5xl md:text-7xl font-bold mb-4">Mount Abu Tour Package - Hill Station of Rajasthan</h1>
            <p className="text-2xl md:text-3xl mb-6">🏔️ Hill Station 🏔️</p>
            <p className="text-xl max-w-3xl mx-auto">Discover the beauty and charm of Mount Abu with unforgettable experiences</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center p-6 bg-blue-50 rounded-xl"><div className="text-4xl mb-3">✈️</div><h3 className="font-bold text-lg mb-2">Nearest Airport</h3><p className="text-gray-700">Udaipur (185km)</p></div>
          </div>

          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold mb-6">About Mount Abu</h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">Mount Abu is a beautiful destination in Rajasthan offering stunning natural beauty, rich cultural heritage, and memorable experiences for travelers.</p>
            <p className="text-gray-700 text-lg leading-relaxed">From scenic attractions to adventure activities, Mount Abu provides the perfect blend of relaxation and excitement for all types of travelers.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md"><h3 className="text-xl font-bold mb-4 text-blue-600">How to Reach</h3><p className="text-gray-700 mb-2"><strong>By Air:</strong> Udaipur (185km)</p><p className="text-gray-700 mb-2"><strong>By Road:</strong> Well-connected</p><p className="text-gray-700"><strong>By Train:</strong> Nearest railway station</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-4xl">
          <TourInquiryForm tourName="Mount Abu Tour Package - Hill Station of Rajasthan" destination="Mount Abu, Rajasthan" />
        </div>
      </section>
