...
export const metadata: Metadata = {
  title: 'Tashkent Tour Package - Heart of Central Asia | GoTraveled',
  description: 'Explore Tashkent - discover amazing attractions and unforgettable experiences.',
};

export default function TashkentTourPage() {
  const attractions = [
  ...
  return (
    <div>
      <section className="relative h-[600px]">
        <Image src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&q=80" alt="Tashkent" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-black/70"></div>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <nav className="text-sm mb-4"><Link href="/tours" className="hover:underline">Tours</Link> / <Link href="/tours/international" className="hover:underline ml-1">International</Link> / <span className="ml-1">Tashkent</span></nav>
            <h1 className="text-5xl md:text-7xl font-bold mb-4">Tashkent Tour Package - Heart of Central Asia</h1>
            <p className="text-2xl md:text-3xl mb-6">🕌 Heart of Central Asia 🕌</p>
            <p className="text-xl max-w-3xl mx-auto">Discover the wonders of Tashkent with our expertly crafted tours</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-6xl">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-blue-50 rounded-xl"><div className="text-4xl mb-3">⏱️</div><h3 className="font-bold text-lg mb-2">Best Duration</h3><p className="text-gray-700">4-6 Days</p></div>
            ...
            <div className="text-center p-6 bg-blue-50 rounded-xl"><div className="text-4xl mb-3">✈️</div><h3 className="font-bold text-lg mb-2">Main Airport</h3><p className="text-gray-700">Tashkent (TAS)</p></div>
          </div>

          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold mb-6">About Tashkent</h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">Tashkent is an incredible destination offering world-class attractions, rich cultural heritage, and unforgettable experiences for international travelers.</p>
            <p className="text-gray-700 text-lg leading-relaxed">From iconic landmarks to unique cultural experiences, Tashkent provides the perfect blend of adventure, relaxation, and discovery.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md"><h3 className="text-xl font-bold mb-4 text-blue-600">Best Season</h3><p className="text-gray-700 mb-2"><strong>Ideal Time:</strong> April-June, Sept-Nov</p><p className="text-gray-700">Plan ahead for the best weather and experiences.</p></div>
            <div className="bg-white p-6 rounded-xl shadow-md"><h3 className="text-xl font-bold mb-4 text-blue-600">How to Reach</h3><p className="text-gray-700 mb-2"><strong>By Air:</strong> Tashkent (TAS)</p><p className="text-gray-700 mb-2"><strong>Visa:</strong> Check requirements</p><p className="text-gray-700"><strong>Currency:</strong> Check exchange rates</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-4xl">
          <TourInquiryForm tourName="Tashkent Tour Package - Heart of Central Asia" destination="Uzbekistan" />
        </div>
      </section>
